        ...
        <tbody className="block md:table-row-group">
          ...
          {tasks.map((task, idx) => {
            ...
            <tr 
              ...
              transform transition-all duration-300 ease-out hover:-translate-y-[2px] md:hover:translate-y-0 hover:shadow-[0_12px_30px_rgba(0,0,0,0.08)] md:hover:shadow-none dark:hover:shadow-[0_8px_30px_rgba(245,124,0,0.08)] md:dark:hover:shadow-none border border-transparent z-10 hover:z-20 relative bg-white md:bg-transparent dark:bg-slate-800 md:dark:bg-transparent`}
            >
