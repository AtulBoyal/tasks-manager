...
function App() {
  ...
  // --- NEW STATES FOR FEATURES 2 & 3 ---
  const [filterStatus, setFilterStatus] = useState('Active'); // Defaults to Active tasks only
  const [showCompleted, setShowCompleted] = useState(false);  // Defaults to hiding the completed table
